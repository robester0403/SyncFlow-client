...
const PendingWorkOrderPage = () => {
  ...
  return (
    <section className="start-workorder-table">
      <TablesHeader
        title="New Workorders"
        searchField={searchField}
        onChangeHandler={onChangeHandler}
      />
      {workOrders.length === 0 ? (
        <div className="start-workorder-table__out-of-workorders">
          <span className="start-workorder-table__message">
            No more new work orders available
          </span>
          <Lottie animationData={outOfOreder} loop={false} autoplay={true} />
        </div>
      ) : (
